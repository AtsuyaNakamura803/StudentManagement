...
public class StudentsCourses {
    ...
    public void validate() {
        if (courseName == null || courseName.isBlank()) throw new IllegalArgumentException("コース名は必須です");
        if (courseStartAt == null) throw new IllegalArgumentException("開始日は必須です");
        if (courseEndAt == null) throw new IllegalArgumentException("終了日は必須です");
    }
